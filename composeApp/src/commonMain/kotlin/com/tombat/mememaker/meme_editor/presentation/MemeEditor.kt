...
import com.tombat.mememaker.meme_editor.presentation.components.BottomBar
import com.tombat.mememaker.meme_editor.presentation.components.ConfirmationDialog
import com.tombat.mememaker.meme_editor.presentation.components.ConfirmationDialogConfig
import com.tombat.mememaker.meme_editor.presentation.components.DraggableContainer
import mememaker.composeapp.generated.resources.Res
import mememaker.composeapp.generated.resources.cancel
import mememaker.composeapp.generated.resources.leave
import mememaker.composeapp.generated.resources.leave_editor_message
import mememaker.composeapp.generated.resources.leave_editor_title
import mememaker.composeapp.generated.resources.meme_template_01
...
fun MemeEditorScreen(
    ...
    if(state.isLeavingWithoutSaving) {
        ConfirmationDialog(
            ...
            onConfirm = {
                onAction(MemeEditorAction.OnConfirmLeaveWithoutSavingClick)
            },
            onDismiss = {
                onAction(MemeEditorAction.OnDiscardChangesClick)
            }
        )
    }
}
